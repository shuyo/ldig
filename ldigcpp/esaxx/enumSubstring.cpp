...
int getID(const string& str, tr1::unordered_map<string, int>& word2id){
  tr1::unordered_map<string, int>::const_iterator it = word2id.find(str);
  if (it == word2id.end()){
...
int main(int argc, char* argv[]){
  ...
  tr1::unordered_map<string, int> word2id;
  ...
  for (tr1::unordered_map<string, int>::const_iterator it = word2id.begin();
       it != word2id.end(); ++it){
